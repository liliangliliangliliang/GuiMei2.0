...
<div id="head">
    <div id="login">
        <div class="login_a" style="margin-left: 12px;width: 80px">
            ...
            <a href="Customer/GUIMEI/gouwuche.html" target="body_i" class="a_login">购物车</a>
        </div>
        <div class="login_a">
        ...
        <div class="login_a" style="width: 100px;margin-left: 5px">
            <a href="cusLog.jsp" target="body_i">
    ...
    <div id="welcome">
        <label><b id="loginName"></b>您好，欢迎${customer.cusLoginName}登录贵美商城！</label><label id="shijian"></label><b id="out"><b>退出</b>
    </b></div>
    ...
    <div id="head_dh">
        <a href="Customer/GUIMEI/homepage.jsp" target="body_i">
